    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto p-8 bg-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Products */}
          <div
            className="p-4 bg-pink-500 shadow-md rounded-lg cursor-pointer hover:shadow-lg transition"
          ...
          {/* Brands */}
          <div
            className="p-4 bg-blue-500 shadow-md rounded-lg cursor-pointer hover:shadow-lg transition"
          ...
          >
            ...
            <p className="text-gray-300">View users Registered!.</p>
          </div>
          {/* Profile */}
          <div
            className="p-4 bg-green-500 shadow-md rounded-lg cursor-pointer hover:shadow-lg transition"
          ...
          {/* Logout */}
          <div
            className="p-4 bg-red-500 shadow-md rounded-lg cursor-pointer hover:shadow-lg transition"
